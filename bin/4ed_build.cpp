...
char *windows_platform_layer[] = { "platform/win32/win32_4ed.cpp", 0 };
char *linux_platform_layer[] = { "platform/linux/linux_4ed.cpp", 0 };
char *mac_platform_layer[] = { "platform/mac/mac_4ed.mm", 0 };
